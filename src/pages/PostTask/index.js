	...
	return (
		<div className="create-task">
			<div className="create-task__progress">
				<span className="create-task__progress-item active">Название</span>
				<span className="create-task__progress-item">Описание</span>
				<span className="create-task__progress-item">Бюджет</span>
				<span className="create-task__progress-item">Публикация</span>
			</div>
			<div className="create-task__stage show">
				...
				<div className="text">
					Придумайте заголовок вашего задания. Кратко опишите, какую задачу надо реализовать исполнителю.
				</div>
				<div className="input">
			...
			<div className="create-task__stage">
				...
				<div className="text">
					Опишите подробно, что необходимо сделать в рамках проекта. Чем подробнее опишите задачу, тем качественнее будет результат.
				</div>
				<div className="text">
					Укажите cущественные требования, которым должен соответствовать результат: форматы файлов, способы проверки и пр.
				</div>
				<div className="input">
					<label for="descr">Описание</label>
					<textarea id="descr" type="text" name="descr" cols="10" rows="10"></textarea>
				</div>
			</div>
			<div className="create-task__stage">
				<div className="title">
				...
				<div className="text">
					Для максимальной эффективности рекомендуем указывать ожидаемую стоимость и сроки.
				</div>
				<div className="input">
					<label for="time">Максимальный срок выполнения</label>
					<div className="input-box">
						<input id="time" type="text" name="time" placeholder="Введите срок" />
				...
				<div className="input">
					...
					<div className="input-box">
						...
						<input id="time" type="text" name="time" placeholder="Стоимость работ согласовывается индивидуально" />
